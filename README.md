# ssd1306
This code is written such that the data is collected from the serial monitor for unlimited strings and characters that are displayed on the SSD1306. This code supports contents to scroll down to the next line once the character/ string reaches the end of the width and length of the screen. Here we have chosen SSD1306x64 and below is the code.
 ...
 * However, there is a modification to be done in the header file which is in our library's location. 
 */
